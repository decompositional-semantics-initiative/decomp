...
from decomp.semantics.predpatt.patt import PredPatt, PredPattOpts, Token, Predicate, Argument
from decomp.semantics.predpatt.patt import NORMAL, APPOS, AMOD, POSS
