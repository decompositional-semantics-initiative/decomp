...
import pytest
import os
from decomp.semantics.predpatt.util.load import load_conllu, DepTriple
from decomp.semantics.predpatt.UDParse import UDParse
...
3	apples	apple	NNS	NNS	_	2	dobj	_	_"""
    ...
    def test_local_deptriple(self):
        ...
        from decomp.semantics.predpatt.util.load import DepTriple as LoaderDepTriple
