...
3	apples	apple	NNS	NNS	_	2	dobj	_	_"""
        ...
        assert parse.tags == ["PRP", "VBP", "NNS"]  # stored as list in modern implementation
...
3	apples	apple	NNS	NNS	_	2	dobj	_	_"""
    ...
    def test_local_deptriple(self):
        """Test that loader uses DepTriple from udparse."""
        ...
        # In modern implementation, they are the same class
        assert LoaderDepTriple is UDParseDepTriple

        # Should have correct repr format
        dt = LoaderDepTriple(rel="nsubj", gov=2, dep=0)
