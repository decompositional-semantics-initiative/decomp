...
from decomp.semantics.predpatt.parsing.loader import load_comm, load_conllu
...
def find_first_difference(str1, str2):
    ...
    for i, (c1, c2) in enumerate(zip(str1, str2, strict=False)):
        if c1 != c2:
            return i, c1, c2
...
class TestDifferentialCorpus:
    ...
    def test_corpus_sentences(self, test_file, options):
        ...
        # Test data files are in parent directory
        ...
        for i, ((orig_id, orig_parse), (mod_id, mod_parse)) in enumerate(
            zip(original_sentences, modern_sentences, strict=False)
        ):
