...
from decomp.semantics.predpatt.core.predicate import Predicate, argument_names
...
class TestArgumentInitialization:
    ...
    def test_mutable_default_rules(self):
        ...
        # arg2's rules should not be affected (but they are due to mutable default!)
        assert len(arg2.rules) == 1  # This is the quirk - mutable default arg
