...
from decomp.semantics.predpatt.rules import g1, h1, h2, i, j, k, w1, w2
...
class TestArgumentRulesDifferential:
    ...
    def create_parse_with_tokens(self, tokens, tags, triples):
        ...
        token_objs = []
        for i, (text, tag) in enumerate(zip(tokens, tags, strict=False)):
...
class TestRuleEquivalence:
    ...
    def test_argument_rule_instances_comparable(self):
        ...
        # Note: class is now G1 but repr shows 'g1(nsubj)' for compatibility
